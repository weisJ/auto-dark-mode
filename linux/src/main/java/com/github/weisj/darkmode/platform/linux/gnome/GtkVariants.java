...
/**
 * This class is effectively a conversion of the GtkVariants.js module seen <a href="https://gitlab.com/rmnvgr/nightthemeswitcher-gnome-shell-extension/-/blob/0d32907de1d004a6a92f02b8e0b79302340e5244/src/modules/GtkVariants.js">here</a>.
 * <p>This class should only be used as a temporary solution until settings are implemented which allow the user to
...
public class GtkVariants {
     ...
     * <p> 	- Remove any signs of a dark variant to the theme name to get the day
     * variant
     * <p> 	- Remove any signs of a light variant to the day variant and add '-dark' to
     * get the night variant
     * <p><p>
     * <p>For themes that don't work with the general rule, a particular case must be written. Day and night variants
     ...
     * <p><p>
     * <p> Light variants, from the most to the least generic:
     * <p> 	- ''
     * <p> 	- '-light'
     * <p> 	- '-darker'
     * <p>
     * <p> Dark variants, from the most the least generic:
     * <p> 	- '-dark'
     * <p> 	- '-darkest'
     *
     * @param themeName the name of a theme. This could be one of the many variants of your theme (i.e. the dark version
     *                  or whatever other variants the theme offers)
     * @return a map containing three keys: "original" (the provided themeName), "day" (the guessed day variant), and
    ...
    public static Map<String, String> guessFrom(String themeName) {
        ...
        if (themeName.contains("Adapta")) {
             ...
             * If themeName was Teja_Darkest (or anything other than _Light), potentialDarkVariant will be ['Teja','Darkest']
             */
    ...
    /**
     * Equivalent to
     * <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/slice">Array.prototype.slice()</a>
     * from JavaScript.
     *
